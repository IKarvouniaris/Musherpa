...
import { requestFeedback } from "@/app/songs/actions";
...
// user has scrolled — same pattern as a chat widget. Only handles asking
// for feedback: requestFeedback reads the song's current lyrics/chords
// straight from the database, so this never needs the lyrics text itself.
        ...
        <div className="fixed bottom-20 right-5 z-40 flex max-h-[75vh] w-[92vw] max-w-sm flex-col border-2 border-paper bg-ink shadow-[6px_6px_0_0_#c9402a]">
          ...
          <div className="flex-1 overflow-y-auto px-4 py-4">
            <p className="mb-3 text-xs text-dust">
              Le manda a Gemini el título, tono, bpm, acordes y letra actual de la canción, y
              trae una opinión sobre cómo viene el concepto.
            </p>
            <button
              type="button"
